...
# Find PlaybookDropdown and next function
start = None
end = None
for i, line in enumerate(lines):
    if b"function PlaybookDropdown" in line:
        start = i
    elif start and (b"export default function" in line or (b"function " in line and i > start + 5)):
        end = i
        break
...
print(f"PlaybookDropdown: lines {start+1} to {end}")
...
print("PlaybookDropdown replaced with server-side search")
